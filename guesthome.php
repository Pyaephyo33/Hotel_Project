        ...
        <tbody>
            ...
            <tr>
                    ...
                    <td width="25%" class="text-center">
                        ...
                        <?php echo '<a class="btn btn-primary" href="roombook.php?RoomID='. $row->RoomID.'">Book</a>';?>&nbsp
                        <?php echo '<a class="btn btn-primary" href="roomreview.php?RoomID='. $row->RoomID.'">WriteReview</a>';?>&nbsp
