<?php
    ...
    $select="SELECT booking_db.BookingID, user_db.FullName, room_db.RoomNo, room_db.RoomType, room_db.RoomImage FROM booking_db INNER JOIN room_db ON booking_db.RoomID=room_db.RoomID
    INNER JOIN user_db ON booking_db.UserID=user_db.UserID WHERE status=2";
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <table>
            <tr>
                <td class="float-left"><h4>Checkout Room List</h4></td>
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <td width="25%" class="text-center">
                        <?php echo '<a class="btn btn-primary" href="checkoutedroom.php?BookingID='. $row->BookingID.'">Accept</a>';?>&nbsp
